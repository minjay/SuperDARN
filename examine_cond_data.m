...
hinfo = hdf5info('OP_2012-02-29_000000.h5');
mag_lat = hdf5read('OP_2012-02-29_000000.h5', '/lat_grid');
mag_lon = hdf5read('OP_2012-02-29_000000.h5', '/lon_grid');
...
ts = hdf5read('OP_2012-02-29_000000.h5', '/ts');
...
ped_cond = fliplr(ped_cond_all(:, :, 2)');
